...
export const metadata: Metadata = {
  title: 'Chauffeur Service in UAE | Airport Transportation | Oregon Town Car',
  description: 'Professional chauffeur service available in the United Arab Emirates. Airport transfers, corporate travel, and executive transportation in Dubai, Abu Dhabi, and throughout UAE.',
  keywords: 'UAE chauffeur service, Dubai airport transportation, Abu Dhabi chauffeur, corporate travel UAE',
};

const majorCities = [
  { name: 'Dubai (DXB)', slug: 'dubai-dxb', description: 'Executive chauffeur service for Dubai International Airport and business districts' },
  { name: 'Abu Dhabi (AUH)', slug: 'abu-dhabi-auh', description: 'Luxury airport transfers and corporate transportation in Abu Dhabi' },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">
              Chauffeur Service in the United Arab Emirates
            </h1>
            <p className="text-lg text-slate-200">
              Professional airport transfers and executive transportation in Dubai, Abu Dhabi, and throughout UAE. 
              The same premium service you trust, now available across the Emirates.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">UAE Chauffeur Availability</h2>
            <p className="text-[var(--textMuted)] mb-4">
              Oregon Town Car partners with vetted professional chauffeur services across the United Arab Emirates to provide 
              seamless airport transfers, corporate travel, and executive transportation. Whether you're traveling to 
              Dubai for business meetings, Abu Dhabi for conferences, or attending international events, 
              our UAE partner network delivers consistent, reliable service.
            </p>
            <p className="text-[var(--textMuted)]">
              All partner chauffeurs are licensed, insured, and trained to the highest standards. You'll experience the 
              same white-glove service, professional communication, and luxury vehicles expected in the Emirates.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Every UAE airport transfer includes complimentary meet & greet service. Your chauffeur will:
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Our UAE chauffeur network specializes in serving business travelers, corporate executives, and VIP clients who require:
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Executive Airport Transfers</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Seamless arrivals and departures for C-suite travelers at DXB and AUH airports. Professional chauffeurs ensure you're on time for 
                  flights and meetings with discreet, reliable service.
                </p>
              </div>

              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">International Business Events</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Coordinate chauffeur service for GITEX, Dubai Expo, and international conferences. 
                  Consistent luxury service across UAE cities.
                </p>
              </div>
              ...
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                ...
                <p className="text-sm text-[var(--textMuted)]">
                  Dedicated account support for companies with frequent UAE travel needs. Centralized billing, travel reporting, 
                  and priority booking for corporate clients.
                </p>
              </div>

              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Multi-City Executive Tours</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Group transportation for roadshows and VIP tours between Dubai, Abu Dhabi, and other Emirates. From solo executive transfers to 
                  luxury coach service for teams.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">UAE Cities We Serve</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Booking UAE Chauffeur Service</h2>
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg p-8">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-sm text-[var(--textMuted)]">
                    Choose from Dubai or Abu Dhabi above. Each city page provides service details, airport coverage, and local information.
                  </p>
                </div>
                <div>
          ...
          <section>
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-lg p-8 text-center">
              <h2 className="text-2xl font-bold mb-3">Book UAE Chauffeur Service</h2>
              <p className="text-slate-200 mb-6 max-w-2xl mx-auto">
                Professional transportation in Dubai, Abu Dhabi, and throughout UAE. Airport transfers, corporate travel, and executive service.
              </p>
              <Link
                href={`/${locale}/contact`}

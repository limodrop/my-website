...
export const metadata: Metadata = {
  title: 'Chauffeur Service in France | Airport Transportation | Oregon Town Car',
  description: 'Professional chauffeur service available in France. Airport transfers, corporate travel, and executive transportation in Paris and throughout France.',
  keywords: 'France chauffeur service, Paris airport transportation, Charles de Gaulle chauffeur, corporate travel France',
};

const majorCities = [
  { name: 'Paris (CDG)', slug: 'paris-cdg', description: 'Executive chauffeur service for Charles de Gaulle Airport and central Paris business districts' },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">
              Chauffeur Service in France
            </h1>
            <p className="text-lg text-slate-200">
              Professional airport transfers and executive transportation in Paris and throughout France. 
              The same premium service you trust, now available across France.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">France Chauffeur Availability</h2>
            <p className="text-[var(--textMuted)] mb-4">
              Oregon Town Car partners with vetted professional chauffeur services across France to provide 
              seamless airport transfers, corporate travel, and executive transportation. Whether you're traveling to 
              Paris for fashion weeks, business meetings, or international events, 
              our French partner network delivers consistent, reliable service.
            </p>
            <p className="text-[var(--textMuted)]">
              All partner chauffeurs are licensed, insured, and trained to the highest French standards. You'll experience the 
              same white-glove service, professional communication, and luxury vehicles no matter where you travel in France.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Every French airport transfer includes complimentary meet & greet service. Your chauffeur will:
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Our French chauffeur network specializes in serving business travelers, corporate executives, and VIP clients who require:
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Executive Airport Transfers</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Seamless arrivals and departures for C-suite travelers at Charles de Gaulle and Orly airports. Professional chauffeurs ensure you're on time for 
                  flights and meetings with discreet, reliable service.
                </p>
              </div>

              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Fashion & Entertainment Events</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Coordinate chauffeur service for Paris Fashion Week, Cannes Film Festival, and international events. 
                  Consistent luxury service across French cities.
                </p>
              </div>
              ...
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                ...
                <p className="text-sm text-[var(--textMuted)]">
                  Dedicated account support for companies with frequent French travel needs. Centralized billing, travel reporting, 
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">French Cities We Serve</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Booking French Chauffeur Service</h2>
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg p-8">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-sm text-[var(--textMuted)]">
                    Choose from our French cities above. Each city page provides service details, airport coverage, and local information.
                  </p>
                </div>
                <div>
          ...
          <section>
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-lg p-8 text-center">
              <h2 className="text-2xl font-bold mb-3">Book French Chauffeur Service</h2>
              <p className="text-slate-200 mb-6 max-w-2xl mx-auto">
                Professional transportation in Paris and throughout France. Airport transfers, corporate travel, and executive service.
              </p>
              <Link
                href={`/${locale}/contact`}

...
export const metadata: Metadata = {
  title: 'Chauffeur Service in Japan | Airport Transportation | Oregon Town Car',
  description: 'Professional chauffeur service available in Japan. Airport transfers, corporate travel, and executive transportation in Tokyo and throughout Japan.',
  keywords: 'Japan chauffeur service, Tokyo airport transportation, Narita chauffeur, corporate travel Japan',
};

const majorCities = [
  { name: 'Tokyo (NRT)', slug: 'tokyo-nrt', description: 'Executive chauffeur service for Narita and Haneda airports, and Tokyo business districts' },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">
              Chauffeur Service in Japan
            </h1>
            <p className="text-lg text-slate-200">
              Professional airport transfers and executive transportation in Tokyo and throughout Japan. 
              The same premium service you trust, now available across Japan.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Japan Chauffeur Availability</h2>
            <p className="text-[var(--textMuted)] mb-4">
              Oregon Town Car partners with vetted professional chauffeur services across Japan to provide 
              seamless airport transfers, corporate travel, and executive transportation. Whether you're traveling to 
              Tokyo for business meetings, technology conferences, or international events, 
              our Japanese partner network delivers consistent, reliable service.
            </p>
            <p className="text-[var(--textMuted)]">
              All partner chauffeurs are licensed, insured, and trained to the highest Japanese standards of service excellence. You'll experience 
              professional communication, punctuality, and luxury vehicles throughout your journey in Japan.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Every Japanese airport transfer includes complimentary meet & greet service. Your chauffeur will:
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Our Japanese chauffeur network specializes in serving business travelers, corporate executives, and VIP clients who require:
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Executive Airport Transfers</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Seamless arrivals and departures for C-suite travelers at Narita and Haneda airports. Professional chauffeurs ensure you're on time for 
                  flights and meetings with discreet, reliable service.
                </p>
              </div>

              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Technology & Business Events</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Coordinate chauffeur service for Tokyo tech conferences, automotive shows, and international business events. 
                  Consistent service across Japanese cities.
                </p>
              </div>
              ...
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                ...
                <p className="text-sm text-[var(--textMuted)]">
                  Dedicated account support for companies with frequent Japanese travel needs. Centralized billing, travel reporting, 
              ...
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                ...
                <p className="text-sm text-[var(--textMuted)]">
                  Group transportation for conferences and executive tours. From solo executive transfers to 
                  mini coach service for business delegations.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Japanese Cities We Serve</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Booking Japanese Chauffeur Service</h2>
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg p-8">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-sm text-[var(--textMuted)]">
                    Choose from our Japanese cities above. Each city page provides service details, airport coverage, and local information.
                  </p>
                </div>
                <div>
          ...
          <section>
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-lg p-8 text-center">
              <h2 className="text-2xl font-bold mb-3">Book Japanese Chauffeur Service</h2>
              <p className="text-slate-200 mb-6 max-w-2xl mx-auto">
                Professional transportation in Tokyo and throughout Japan. Airport transfers, corporate travel, and executive service.
              </p>
              <Link
                href={`/${locale}/contact`}

...
export const metadata: Metadata = {
  title: 'Chauffeur Service in the United States | Airport Transportation | Oregon Town Car',
  description: 'Professional chauffeur service available in major US cities. Airport transfers, corporate travel, and executive transportation in New York, Los Angeles, San Francisco, Chicago, Miami, and more.',
  keywords: 'US chauffeur service, United States airport transportation, corporate travel USA, executive car service',
};

const majorCities = [
  { name: 'New York (JFK, LGA, EWR)', slug: 'new-york-jfk', description: 'Executive chauffeur service for all NYC airports and Manhattan business districts' },
  { name: 'Los Angeles (LAX)', slug: 'los-angeles-lax', description: 'Luxury airport transfers and corporate transportation throughout LA metro' },
  { name: 'San Francisco (SFO)', slug: 'san-francisco-sfo', description: 'Professional chauffeur service for SFO, Silicon Valley, and Bay Area' },
  { name: 'Chicago (ORD)', slug: 'chicago-ord', description: 'Reliable airport transportation and corporate travel in Chicago' },
  { name: 'Miami (MIA)', slug: 'miami-mia', description: 'Premium chauffeur service for Miami International and South Florida' },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">
              Chauffeur Service in the United States
            </h1>
            <p className="text-lg text-slate-200">
              Professional airport transfers and executive transportation in major US cities. 
              The same premium service you trust, now available nationwide.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Nationwide Chauffeur Availability</h2>
            <p className="text-[var(--textMuted)] mb-4">
              Oregon Town Car partners with vetted professional chauffeur services across the United States to provide 
              seamless airport transfers, corporate travel, and executive transportation. Whether you're traveling to 
              New York for business meetings, Los Angeles for entertainment industry events, or Chicago for conferences, 
              our nationwide network delivers consistent, reliable service.
            </p>
            <p className="text-[var(--textMuted)]">
              All partner chauffeurs are licensed, insured, and trained to our Portland standards. You'll experience the 
              same white-glove service, professional communication, and luxury vehicles no matter which US city you visit.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Every US airport transfer includes complimentary meet & greet service. Your chauffeur will:
            </p>
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-[var(--textMuted)]">Meet you at baggage claim with a professional name sign</span>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[var(--primary)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Our US chauffeur network specializes in serving business travelers, corporate executives, and VIP clients who require:
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Executive Airport Transfers</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Seamless arrivals and departures for C-suite travelers. Professional chauffeurs ensure you're on time for 
                  flights and meetings with discreet, reliable service.
                </p>
              </div>

              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Multi-City Business Travel</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Coordinate chauffeur service across multiple US cities for roadshows, conferences, and executive tours. 
                  Consistent service in NYC, LA, SF, Chicago, and beyond.
                </p>
              </div>
              ...
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                ...
                <p className="text-sm text-[var(--textMuted)]">
                  Dedicated account support for companies with frequent US travel needs. Centralized billing, travel reporting, 
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Major US Cities We Serve</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Booking US Chauffeur Service</h2>
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg p-8">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-sm text-[var(--textMuted)]">
                    Choose from our major US cities above. Each city page provides service details, airport coverage, and local information.
                  </p>
                </div>
                <div>
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-sm text-[var(--textMuted)] mb-3">
                  Professional airport transfers in Portland and nationwide.
                </p>
          ...
          <section>
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-lg p-8 text-center">
              <h2 className="text-2xl font-bold mb-3">Book US Chauffeur Service</h2>
              <p className="text-slate-200 mb-6 max-w-2xl mx-auto">
                Professional transportation in major US cities. Airport transfers, corporate travel, and executive service nationwide.
              </p>
              <Link
                href={`/${locale}/contact`}

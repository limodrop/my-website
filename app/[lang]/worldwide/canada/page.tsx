...
export const metadata: Metadata = {
  title: 'Chauffeur Service in Canada | Airport Transportation | Oregon Town Car',
  description: 'Professional chauffeur service available in major Canadian cities. Airport transfers, corporate travel, and executive transportation in Toronto, Vancouver, Montreal, and more.',
  keywords: 'Canada chauffeur service, Canadian airport transportation, corporate travel Canada, executive car service',
};

const majorCities = [
  { name: 'Toronto (YYZ)', slug: 'toronto-yyz', description: 'Executive chauffeur service for Pearson Airport and downtown Toronto business districts' },
  { name: 'Vancouver (YVR)', slug: 'vancouver-yvr', description: 'Luxury airport transfers and corporate transportation throughout Vancouver metro' },
  { name: 'Montreal (YUL)', slug: 'montreal-yul', description: 'Professional chauffeur service for Montreal-Trudeau Airport and city center' },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-slate-200">
              Professional airport transfers and executive transportation in major Canadian cities. 
              The same premium service you trust, now available across Canada.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Chauffeur Availability Across Canada</h2>
            <p className="text-[var(--textMuted)] mb-4">
              Oregon Town Car partners with vetted professional chauffeur services across Canada to provide 
              seamless airport transfers, corporate travel, and executive transportation. Whether you're traveling to 
              Toronto for financial meetings, Vancouver for tech industry events, or Montreal for conferences, 
            ...
            <p className="text-[var(--textMuted)]">
              ...
              same white-glove service, professional communication, and luxury vehicles no matter which Canadian city you visit.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Every Canadian airport transfer includes complimentary meet & greet service. Your chauffeur will:
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--textMuted)] mb-6">
              Our Canadian chauffeur network specializes in serving business travelers, corporate executives, and VIP clients who require:
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Executive Airport Transfers</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Seamless arrivals and departures for C-suite travelers at YYZ, YVR, and YUL. Professional chauffeurs ensure you're on time for 
              ...
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                ...
                <p className="text-sm text-[var(--textMuted)]">
                  Coordinate chauffeur service across Canadian cities for roadshows, conferences, and executive tours. 
                  Consistent service in Toronto, Vancouver, Montreal, and beyond.
                </p>
              </div>
              ...
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                ...
                <p className="text-sm text-[var(--textMuted)]">
                  Dedicated account support for companies with frequent Canadian travel needs. Centralized billing, travel reporting, 
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Major Canadian Cities We Serve</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Booking Canadian Chauffeur Service</h2>
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg p-8">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-sm text-[var(--textMuted)]">
                    Choose from our major Canadian cities above. Each city page provides service details, airport coverage, and local information.
                  </p>
                </div>
                <div>
          ...
          <section>
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-lg p-8 text-center">
              <h2 className="text-2xl font-bold mb-3">Book Canadian Chauffeur Service</h2>
              <p className="text-slate-200 mb-6 max-w-2xl mx-auto">
                Professional transportation in major Canadian cities. Airport transfers, corporate travel, and executive service nationwide.
              </p>
              <Link
                href={`/${locale}/contact`}

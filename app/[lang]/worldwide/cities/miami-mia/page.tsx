...
export const metadata: Metadata = {
  title: 'Chauffeur Service in Miami (MIA) | Airport Transportation | Oregon Town Car',
  description: 'Professional chauffeur service at Miami International Airport. Executive transportation throughout Miami, South Beach, and South Florida.',
  keywords: 'Miami chauffeur, MIA airport transportation, South Beach car service, Miami executive transportation',
};

export default function MiamiMIAPage({
  params
}: {
  params: { lang: Locale }
}) {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">
              Chauffeur Service in Miami (MIA)
            </h1>
            <p className="text-lg text-slate-200">
              Professional airport transfers and executive transportation at Miami International Airport. 
              Serving Miami Beach, Brickell, Fort Lauderdale, and South Florida.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Miami Chauffeur Availability</h2>
            <p className="text-[var(--textMuted)] mb-4">
              Our vetted chauffeur partners serve Miami International Airport (MIA) and Fort Lauderdale-Hollywood (FLL) throughout South Florida. 
              Whether you're arriving for cruise departures, international business meetings, or luxury events, 
              professional chauffeurs provide seamless transportation.
            </p>
            <p className="text-[var(--textMuted)]">
              Service covers Miami Beach, South Beach, Brickell Financial District, Coral Gables, Coconut Grove, and Fort Lauderdale. 
              All chauffeurs are licensed, insured, and experienced with Miami traffic and cruise terminal access.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Airport & Cruise Transfers</h2>
            <div className="space-y-4">
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-5">
                <h3 className="font-semibold text-[var(--text)] mb-2">✓ MIA & FLL Airports</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Professional pickup at Miami International and Fort Lauderdale airports with luggage assistance.
                </p>
              </div>
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-5">
                <h3 className="font-semibold text-[var(--text)] mb-2">✓ Cruise Port Transportation</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Dedicated service to Port Miami, Port Everglades, and cruise terminal drop-offs/pickups.
                </p>
              </div>
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-5">
                <h3 className="font-semibold text-[var(--text)] mb-2">✓ Beach & Downtown Access</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Express routes to South Beach hotels, Brickell offices, and Miami Design District.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Financial & Business Centers</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Transportation to Brickell banking towers, Coral Gables offices, and international trade zones.
                </p>
              </div>
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
                <h3 className="font-semibold text-[var(--text)] mb-2">Event & Convention Service</h3>
                <p className="text-sm text-[var(--textMuted)]">
                  Art Basel, Miami Beach Convention Center, and luxury hotel event transportation.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-lg p-8 text-center">
              <h2 className="text-2xl font-bold mb-3">Book Miami Chauffeur Service</h2>
              <p className="text-slate-200 mb-6">Professional transportation at MIA. Executive service throughout South Florida.</p>
